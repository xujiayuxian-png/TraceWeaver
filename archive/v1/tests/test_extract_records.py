...
def test_extract_records_reads_registration_success() -> None:
    extracted = extract_records(FIXTURES_DIR / "01_registration_success.pcapng")
...
def test_extract_records_reads_http2_and_sm_messages() -> None:
    extracted = extract_records(FIXTURES_DIR / "02_registration_and_pdu_session_success.pcapng")
...
def test_extract_records_reads_reject_cause() -> None:
    extracted = extract_records(FIXTURES_DIR / "03_registration_reject.pcapng")
...
def test_extract_records_limit_is_applied_after_filtering() -> None:
    extracted = extract_records(FIXTURES_DIR / "01_registration_success.pcapng", limit=5)
